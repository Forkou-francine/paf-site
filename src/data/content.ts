...
const frenchContent: PortfolioContent = {
  profile: {
    ...
    bio: "Ingénieure logiciel de formation, je me suis spécialisée dans la data parce que j'aime quand les chiffres racontent une histoire. En ce moment, cette histoire c'est celle des réclamations de millions d'allocataires — et je la rends lisible pour ceux qui doivent agir.",
    ...
    softSkills: [
      ...
      "J'analyse - Je sais traduire un besoin métier en requête SQL",
    ],
  ...
  experiences: [
    {
      ...
      period: "Sept. 2024 - Sept. 2026",
      bullets: [
        "Redesigned the national complaints tracking system: designed and deployed a Power BI dashboard used by 101 CAF branches and 500 users, replacing an obsolete SAS application.",
        "Developed ETL pipelines on Databricks (PySpark) processing millions of complaints/year with a Medallion architecture (Bronze/Silver/Gold).",
        "Orchestrated 6 notebooks via Databricks Workflows with an optimized execution time of 57 minutes in monthly batch.",
        "Implemented data governance via Unity Catalog and storage on Delta Lake / Azure Storage.",
        "Created a SAAD dashboard for monitoring Home Care Services, consolidating data from multiple funders (CAF, Departments, CPAM).",
        "Led training workshops for 100 business users on dashboard adoption.",
        "Reviewed and standardized existing Python/Spark notebooks: improved performance and compliance with best practices.",
        "Conducted a Databricks AI/BI POC (Genie Room): evaluated natural language querying capabilities, recommendations adopted by the team.",
        "Collaborated with MOA/AMOA teams; pipeline versioning and maintenance via Git (Azure DevOps).",
      ],
      tech: ["Databricks", "Python", "Spark", "Power BI", "Azure", "Unity Catalog", "Delta Lake", "Azure DevOps", "Git"],
    },
    {
      ...
      bullets: [
        "Developed a data visualization solution for optical transport networks: Python API (FastAPI) and TypeScript (Vue.js) to create interactive dashboards.",
        "Administered NoSQL databases (MongoDB) on Kubernetes clusters (Linux).",
        "Implemented CI/CD pipelines via GitLab CI and SonarQube for quality control.",
      ],
      tech: ["FastAPI", "Vue.js", "TypeScript", "MongoDB", "Kubernetes", "GitLab CI", "SonarQube"],
    },
  ],
