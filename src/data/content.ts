  ...
  experiences: [
    {
      ...
      bullets: [
        ...
        "Orchestration de 6 notebooks via Databricks Workflows avec un temps d'exécution optimisé de 57 minutes en batch mensuel.",
        "Implémentation de la gouvernance des données via Unity Catalog et stockage sur Delta Lake / Azure Storage.",
        "Création d'un tableau de bord SAAD pour le pilotage des Services d'Aide à Domicile, consolidant les données de financeurs multiples (CAF, Départements, CPAM).",
